...
GPT_MODEL = GPT_MODEL_3 # Default model
...
def measure_time_total(f):
    ...
    def timed(*args, **kw):
        ...
        # print('[TOTAL TIME] %r %2.2f sec INPUT (%r, %r) OUTPUT %r' % \
        #       (f.__name__, dur, args, kw, result))
        return result
...
def measure_time(f):
    ...
    def timed(*args, **kw):
        ...
        # print('[TIME] %r %2.2f sec INPUT (%r, %r) OUTPUT %r' % \
        #       (f.__name__, dur, args, kw, result))
        return result
